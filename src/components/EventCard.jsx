      ...
      <div className="flex items-start justify-between mb-6 sm:mb-8">
        <div className="flex-1">
          <div className="flex items-center gap-3 mb-3 sm:mb-4">
            ...
            <span className="text-xs sm:text-sm font-medium text-gray-600 dark:text-slate-400 uppercase tracking-wider">Event</span>
          </div>
      ...
      <div className="grid md:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
        ...
        <div className="bg-gray-50/70 dark:bg-slate-700/40 rounded-lg sm:rounded-xl p-4 sm:p-6 border border-gray-200/50 dark:border-slate-600/30">
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div>
              <h3 className="text-xs sm:text-sm font-semibold text-gray-600 dark:text-slate-300 uppercase tracking-wide mb-1 sm:mb-2">Duration</h3>
        ...
        <div className="bg-gray-50/70 dark:bg-slate-700/40 rounded-lg sm:rounded-xl p-4 sm:p-6 border border-gray-200/50 dark:border-slate-600/30">
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div>
              ...
              <p className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white">Scheduled</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="bg-gray-50/70 dark:bg-slate-700/40 rounded-lg sm:rounded-xl p-4 sm:p-6 border border-gray-200/50 dark:border-slate-600/30">
            <div className="flex items-start gap-3 sm:gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-700 dark:text-slate-200 leading-relaxed text-sm sm:text-base md:text-lg">{event.description}</p>
              </div>
            </div>
          </div>
        </div>
