      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8">
        <div className="flex justify-between items-center h-14 sm:h-16">
          ...
          <div className="flex items-center min-w-0 flex-shrink-0">
            <h1 className="text-base sm:text-xl md:text-2xl font-bold text-gray-900 dark:text-white tracking-tight truncate">
              My Calendar
            </h1>
          </div>

          {/* User section - more space allocated */}
          <div className="flex items-center space-x-2 sm:space-x-3 ml-2 min-w-0 flex-1 justify-end">
            {/* User info with more generous width */}
            <div className="flex items-center space-x-1.5 sm:space-x-2 px-2 sm:px-3 py-1.5 sm:py-2 rounded-lg sm:rounded-xl bg-gray-50/80 dark:bg-gray-800/50 text-xs sm:text-sm text-gray-700 dark:text-gray-300 border border-gray-200/50 dark:border-gray-700/50 min-w-0 flex-1 max-w-xs">
